...
def prepare_rave(dataset_path, output_path, alpha, temp_dir, sr=44100, n_threads=10):
...
if __name__ == "__main__":
    ...
    prepare_rave(opt.dataset_path, opt.output_path, opt.alpha, opt.temp_dir, opt.sr, opt.n_threads)
