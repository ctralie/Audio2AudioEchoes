...
Note that there are a lot of silences in individual tracks, but this mirrors a more realistic scenario
...
\begin{figure}
    ...
    \caption{Embedding 30 seconds of an excerpt from Prince}
...
\begin{figure}
    ...
    \caption{Dance diffusion example}
...
\begin{figure*}
    \centering
    \onecolumn
    \includegraphics[width=\textwidth]{figs/SingleEchoTable.png}
